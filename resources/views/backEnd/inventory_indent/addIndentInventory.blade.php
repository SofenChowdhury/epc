    ...
    <div class="card">
        ...
        <div class="card-header">
            <div class="text-right">
                <a href="{{route('check_indents_Inventory')}}" >
        ...
        <form action="{{url('insert_indents_Inventory')}}" method="post">@csrf
            ...
            <div class="row">
                <div class="col-md-12 table-responsive">
                    <table class="table table-sm voucher-table">
                        <thead>
                        <tr class="table-info">
                            <th scope="col" width="20%">Item No.</th>
                        ...
                        <tr class="table pb-0">
                            <td class="pb-0">
                                <div class="form-group">
                                    <input type="number" class="form-control" name="vendor[]" placeholder="Item No."/>
                                </div>
                            </td>
                            <td class="pb-0">
                                <div class="form-group">
                                    <input type="text" class="form-control" name="purpose[]" placeholder="Description"/>
                                </div>
                            </td>
                            <td class="pb-0">
                                <div class="form-group">
                                    <input type="number" class="form-control" name="exp_code[]" placeholder="Quantity"/>
                                </div>
                            </td>
                            <td class="pb-0">
                                <div class="form-group">
                                    <input type="number" class="form-control" name="amount[]" placeholder="Price"/>
                                </div>
                            </td>
                        </tr>
                        </tbody>
