...
<div class="card">
    <div class="card-header">
        ...
        <a href="{{ url('print_projects/active') }}" style="padding: 6px 12px; margin-top: 10px; color: white;"
           class="btn btn-success"> Print Active Projects</a>
        ...
        @can('Add/Edit Project')
            ...
            <a href="{{ url('projects/completed') }}"
               ...
               class="btn btn-success"> Completed Projects </a>
        @endcan
    </div>
        ...
        <div class="table-responsive">
            <table id="basic-btn" class="table table-striped table-bordered">
                ...
                <tr>
                    ...
                    <th>Funded By</th>
                    <th>Contract Type</th>
                    <th>Association With Other Firm</th>
                    <th>Client</th>
                    <th>Status</th>
                    <th>Ministry</th>
                    <th>Actions</th>
                ...
                @foreach($projects as $project)
                    ...
                    @if($project->project_status !='completed' && $project->project_status !='cancelled' && $project->project_status !='withdrawn' && $project->project_status !='not submitted')
                        ...
                        <td>
	                        ...
	                        @can('Add/Edit Project')
                                <a href="{{ route('project.edit',$project->id) }}" title="Edit">
                                    <button type="button" class="btn btn-info action-icon"><i class="fa fa-edit"></i>
                                    </button>
                                </a>
                            @endcan
                            @if(Auth::user()->getRoleNames()->first() == 'Super Admin')
                                <a class="modalLink" title="Delete" data-modal-size="modal-md"
                                   href="{{url('deleteProjectView', $project->id)}}">
