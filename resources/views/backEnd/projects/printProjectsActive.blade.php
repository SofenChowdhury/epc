...
<div class="card-block" id="page">
    ...
    <div class="row" id="logo">
        ...
        <div class="col-md-4" style="text-align: center; font-weight: bold; padding:3% 0 3% 5%;">
            <p style="margin-top: 25px; font-size: 26px; ">Active Projects List</p>
        </div>
    </div>
    <div class="row">
        ...
        <div class="table-responsive">
            <table id="basic-btn" class="table table-striped table-bordered">
                ...
                @foreach($projects as $project)
                    @if($project->project_status !='completed' && $project->project_status !='cancelled' && $project->project_status !='withdrawn')
