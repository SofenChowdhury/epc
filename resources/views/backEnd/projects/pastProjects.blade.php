...
@section('mainContent')
    ...
    <div class="card">
        <div class="card-header">
            ...
            <a href="{{ url('print_projects/past') }}" style="padding: 6px 12px; margin-top: 10px; color: white;"
               class="btn btn-success"> Print Past Projects</a>
            ...
            @can('Add/Edit Project')
                ...
                <a href="{{ url('projects/completed') }}" style="float: right; padding: 8px; color: white;margin-right: 10px"
