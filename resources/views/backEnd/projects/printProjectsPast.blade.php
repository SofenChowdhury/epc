...
<head>
    ...
    <link rel="stylesheet" href="{{asset('public/assets/pages/chart/radial/css/radial.css')}}" type="text/css"
          media="all">
...
<div class="card-block" id="page">
    ...
    <div class="row" id="logo">
        ...
        <div class="col-md-4" style="text-align: center; font-weight: bold; padding:3% 0 3% 5%;">
            <p style="margin-top: 25px; font-size: 26px; ">Past Projects List</p>
        </div>
    </div>
    <div class="row">
        ...
        <div class="table-responsive">
            <table id="basic-btn" class="table table-striped table-bordered">
                ...
                @foreach($projects as $project)
                    @if($project->project_status == 'withdrawn' || $project->project_status =='cancelled' || $project->project_status =='Not Submitted')
...
<div class="text-bottom text-center pt-5 mt-5">
    <div class="row">
        <div class="col" style="background-color: #4a5f68; position:fixed; bottom: 0">
            <p class=" " style="font-size: 0.9rem; background-color: #4a5f68">ERP Version 1.1 | Developed by: White
                Paper | Printed By: {{ Auth::user()->name }} | <span id="datetime"></span></p>
        </div>
    </div>
</div>
...
<script type="text/javascript"
        src="{{asset('public/bower_components/jquery-slimscroll/js/jquery.slimscroll.js')}}"></script>
