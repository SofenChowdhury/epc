...
@section('mainContent')
    <div class="card">
        <div class="card-header">
            <h5>Edit Reporting </h5>
        </div>
        <div class="card-block">
            {{ Form::open(['class' => '', 'files' => true, 'url' => 'project_reporting/'.$editData->id, 'method' => 'PUT', 'enctype' => 'multipart/form-data', 'autocomplete' => 'off']) }}
            @csrf
            <div class="row">
            ...
            <div class="row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control  {{ $errors->has('no_of_copies') ? ' is-invalid' : '' }}" value="{{ $editData->no_of_copies }}" name="no_of_copies" />
            ...
            <div class="row">
                <div class="form-group col-md-6">
                    ...
                    <input type="" class="form-control datepicker {{ $errors->has('due_date') ? ' is-invalid' : '' }}" value="{{ $editData->due_date ? date('d-m-Y', strtotime($editData->due_date)) : ''  }}" name="due_date"/>
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="" class="form-control datepicker {{ $errors->has('submitted_on') ? ' is-invalid' : '' }}" value="{{ $editData->submitted_on ? date('d-m-Y', strtotime($editData->submitted_on)) : '' }}" name="submitted_on"/>
