                        ...
                        <tbody id="IndentData">
                            <tr class="table pb-0">
                                <td class="pb-0">
                                    @if(isset($data->id))
                                        <div class="form-group">
                                            <input class="form-control" type="text" name="vendor[]" value="{{$data->vendor}}" required/><br>
                                            {{$data->vendor}}
                                        </div>
                                    @endif
                                </td>
                                ...
                                <td class="pb-0">
                                    @if(isset($data->id))
                                        <div class="form-group">
                                            <input class="form-control" type="text" name="exp_code[]" value="{{$data->exp_code}}" required/><br>
                                            {{$data->exp_code}}
                                        </div>
                                    @endif
                                </td>
