        ...
        buttons: [
            'copy', 'csv', 'excel', 'pdf',
            {
                ...
                customize: function ( win ) {
                    $(win.document.body)
                        ...
                        .prepend(
                            ...
                            '       <img class="img-fluid" src="{{URL::asset(\'assets/images/epc_logo.png\')}}" alt="logo" height="8" width="60">'+
                            '<p style="font-weight: bold; font-size: 1.2em">Engineering & Planning Consultants Limited</p>'+
                            // '       <img class="img-fluid" src="public_path(\'/public/assets/images/epc_logo.png\')" alt="logo" height="10" width="120">\n' +
                            // '       <img class="img-fluid" src="'+ url("public/assets/images/epc_logo.png") +'" alt="logo" height="10" width="120">\n' +
                            '   </div>' +
                            '</div>'
                        );
                ...
                .append(
                        ...
                        '                <p class=" " style="font-size: 0.9rem; background-color: #4a5f68" >ERP Version 1.0 </p>\n' +
                        '            </div>\n' +
                        '        </div>\n' +
                        '    </div>'
                    );
                ...
                customize: function ( win ) {
                    $(win.document.body)
                        ...
                        .prepend(
                            '<div class="row" id="logo">' +
                            '   <div class="col-md-4" style="padding:3% 0 3% 5%;">' +
                            '       <img class="img-fluid" src="public_path(public/assets/images/epc_logo.png)" alt="image" height="10" width="120">'+
                            // '       <img class="img-fluid" src="{{asset(\'/public/assets/images/epc_logo.png\')}}" alt="image" height="10" width="120">\n' +
                            // '       <img class="img-fluid" src="' . url("public/assets/images/epc_logo.png") . '" alt="image" height="10" width="120">\n' +
                            '   </div>' +
                            '</div>'
                        );
